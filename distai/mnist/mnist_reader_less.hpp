...
std::vector<std::vector<Pixel>> read_training_images() {
    return read_mnist_image_file(DATA_FOLDER"/train-images-idx3-ubyte");
}
...
std::vector<std::vector<Pixel>> read_test_images() {
    return read_mnist_image_file(DATA_FOLDER"/t10k-images-idx3-ubyte");
}
...
std::vector<Label> read_training_labels() {
    return read_mnist_label_file(DATA_FOLDER"/train-labels-idx1-ubyte");
}
...
std::vector<Label> read_test_labels() {
    return read_mnist_label_file(DATA_FOLDER"/t10k-labels-idx1-ubyte");
}
